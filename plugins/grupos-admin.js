...
let pesan = args.join` `
let oi = `» ♥️ ${lenguajeGB['smsAddB5']()} ${pesan}`
...
await conn.reply(NumeroUser + '@s.whatsapp.net', `✨ *¡Hola! @${NumeroUser}, @${user} ¡¡Nani Bot te ha invitado!!*`, null, {mentions: [NumeroUser + '@s.whatsapp.net', m.sender]})    
